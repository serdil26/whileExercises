...
public class BankamatikProje {
	...
	public static void main(String[] args) {
		/*Kullaniciya giriþ için kart numarasi ve þifresini isteyin, eger herhangi birini
       ...
       Para gönderme iþleminde istenen iban TR ile baslamali ve toplam 26 karakterli olmali,
        eger deðilse menü ekranina geri donsun.
